...
import { auth, UserRole, getRoleBasedRedirectUrl } from '@/lib/auth'
...
export function RegisterForm({ redirectTo, allowRoleSelection = true, defaultRole = 'buyer' }: RegisterFormProps) {
